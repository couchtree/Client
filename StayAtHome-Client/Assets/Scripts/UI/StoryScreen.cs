...
public class StoryScreen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        storyParts.Add("Nachdem du aufgestanden und dich vom ersten Schock erholt hast, liest du den Artikel weiter. Nach diesem sei eine Plage an neuartigen Blattläusen ausgebrochen, welche jegliche Art an Pflanzen befällt, welche sich im Freien befinden und von Menschen umgeben sind.");
        storyParts.Add("Pflanzen in geschlossenen Räumen, mit wenig Menschen in der Nähe seien weniger anfällig. Daher werde jeder Bürger gebeten sich so viel wie möglich daheim aufzuhalten und eigene Pflanzen zu halten, um die Plage nicht zu fördern, bis diese vorüber ist und um jeglichen Verlust an Pflanzen so niedrig wie möglich zu halten.");
