...
{
    /// <summary>
    /// Time Handler managing the periodically requests to the backend server.
    /// 
    /// Requests the nearby players from the backend server and takes approriated action
    /// </summary>
    public class TimeHandler : MonoBehaviour
    {
        ...
        /// <summary>
        /// Calls the RequestUpdate-method in period itervals
        /// </summary>
        void Update()
        {
        ...
        /// <summary>
        /// Request the players around the current player from the backend-server
        /// </summary>
        ...
        /// <summary>
        /// Handles the server response on a request for all nearby players
        /// </summary>
        /// <param name="responseMsg">JSON-string from the server</param>
